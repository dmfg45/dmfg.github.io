    ...
    <div class="box text-center"><!-- box -->
        ...
        <form action="" method="post"><!-- form -->
            ...
            <div class="form-group"><!-- form-group -->
                ...
                <h4><a href="forgotPassw.php">Forgot Your Password?</a></h4>
            </div><!-- /form-group -->
            <div class="form-group"><!-- form-group -->
        ...
        <h5>New customer?<br><h4>&dArr;</h4></h5>
        <a href="customerRegister.php"><h5>Register Here</h5></a>
    </div><!-- /box -->
...
if (isset($_POST['login'])) {
    ...
    $customer = "select * from onlinestore.customers where customer_email = '$customerEmail'";
    ...
    $hashPassw = $customerRow['customer_pass'];
    $decryptPass = password_verify($customerPassw, $hashPassw);

    if ($decryptPass == 0) {
        ?>
        <script>alert('Your password or email is wrong or misspelled')</script>
