                        ...
                        <table class="table table-bordered table-hover table-stripped">
                            ...
                            while ($rowC = mysqli_fetch_array($runQuery)) {
                                ...
                                <tr>
                                    ...
                                    <td><img src="slidesImages/<?php echo $slideImage ?>" alt="SlideIMG" width="250"
                                             height="250" class="img-responsive"></td>
                                    <td><a href="index.php?deleteSlide=<?php echo $slideId ?>"><i
                                                    class="fas fa-times-circle fa-2x"></i></a></td>
                                    <td><a href="index.php?editSlide=<?php echo $slideId ?>"><i
