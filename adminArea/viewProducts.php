                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-stripped">
                            ...
                            $query = "select * from onlinestore.products where status = 'product'";
                            ...
                            while ($row = mysqli_fetch_array($runQuery)) {
                                ...
                                <tr>
                                    ...
                                    <td><a href="index.php?deleteProduct=<?php echo $productId ?>"><i
                                                    class="fas fa-times-circle fa-2x"></i></a></td>
                                    <td><a href="index.php?editProduct=<?php echo $productId ?>"><i
