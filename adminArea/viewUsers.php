                        ...
                        <table class="table table-bordered table-hover table-stripped">
                            ...
                            while ($row = mysqli_fetch_array($runQuery)) {
                                ...
                                <tr>
                                    ...
                                    <td><img width="75" height="75" src="adminImages/<?php echo $adminImage ?>"
                                             alt="ProdImg"></td>
                                    <td><?php echo $adminCountry ?></td>
                                    <td><?php echo $adminContact ?></td>
                                    <td><?php echo $adminJob ?></td>
                                    <td><a href="index.php?deleteAdmin=<?php echo $adminId ?>"><i
                                                    class="fas fa-times-circle fa-2x"></i></a></td>
                                    <!--                                    <td><a href="index.php?editAdmin=-->
                                    <?php //echo $adminId
                                    ?><!--"><i class="fas fa-user-edit fa-2x"></i></a></td>-->
                                </tr>
                                <?php
