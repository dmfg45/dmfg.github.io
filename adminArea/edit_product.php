                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-md-9">
                                ...
                                <div class="form-group"><!-- form-group  -->
                                    <label for="" class="control-label">Product Seo Description</label>
                                ...
                                <div class="form-group"><!-- form-group  -->
                                    <label for="" class="control-label">Product Url</label>
                                ...
                                <div class="form-group"><!-- form-group  -->
                                    <label for="" class="control-label">Product Weight <small> (kg) </small></label>
                                ...
                                <div class="form-group"><!-- form-group  -->
                                    <label for="" class="control-label">Product Sale Price</label>
                                        <input type="text" name="product_sale_price" class="form-control"
                                               value="<?php echo $productSalePrice ?>">
                                </div><!-- /form-group  -->
                                <div class="form-group"><!-- form-group  -->
                                    <label for="" class="control-label">Product Keywords</label>
                                        <input type="text" name="product_keywords" class="form-control"
                                               value="<?php echo $productKeywords ?>">
                                </div><!-- /form-group  -->
                                <div class="form-group"><!-- form-group  -->
                                    <label for="" class="control-label">Product Label</label>
                                        <input type="text" name="product_label" class="form-control"
                                               value="<?php echo $productLabel ?>">
                                </div><!-- /form-group  -->
                                    ...
                                    <label for="" class="control-label">Product Type</label>
                                        <select name="productType" id="" class="form-control">
                                            ...
                                            if ($product_type == "physicalProduct"){
                                                ?>
                                                <option value="<?php echo $product_type ?>">(Physical Product) Simple Product</option>
                                                <option value="digitalProduct">(Digital Product) Downloadable Product</option>
                                            <?php
                                            }elseif ($product_type == "digitalProduct"){
                                                ?>
                                                <option value="<?php echo $product_type ?>">(Digital Product) Downloadable Product</option>
                                                <option value="physicalProduct">(Physical Product) Simple Product</option>
                                            <?php
                                            }else{ ?>
                                                <option value="physicalProduct">(Physical Product) Simple Product</option>
                                                <option value="digitalProduct">(Digital Product) Downloadable Product</option>
