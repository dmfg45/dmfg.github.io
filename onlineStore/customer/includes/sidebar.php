        ...
        <div class="panel-body"><!-- panel-body -->
            <ul class="nav nav-pills nav-stacked"><!-- nav-pills -->
                <li class="<?php if (isset($_GET['myOrders'])) {
                    echo "active";
                } ?>"><a href="myAccount.php?myOrders"><i class="fas fa-list"></i>&nbsp;My Orders</a></li>
                <li class="<?php if (isset($_GET['payOffline'])) {
                    echo "active";
                } ?>"><a href="myAccount.php?payOffline"><i class="fas fa-bolt"></i>&nbsp;Pay Offline</a></li>
                <li class="<?php if (isset($_GET['editAccount'])) {
                    echo "active";
                } ?>"><a href="myAccount.php?editAccount"><i class="fas fa-pencil-alt"></i>&nbsp;Edit Account</a></li>
                <li class="<?php if (isset($_GET['changePass'])) {
                    echo "active";
                } ?>"><a href="myAccount.php?changePass"><i class="fas fa-lock"></i>&nbsp;Change Password</a></li>
                <li class="<?php if (isset($_GET['delAccount'])) {
                    echo "active";
                } ?>"><a href="myAccount.php?delAccount"><i class="fas fa-trash-alt"></i>&nbsp;Delete Account</a></li>
