                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-stripped">
                            ...
                            <?php
                                ...
                                $productCatDesc = $rowPC['p_cat_desc'];
                            ...
                            <tr>
                                ...
                                <td width="300"><?php echo $productCatDesc ?></td>
                                <td><a href="index.php?deleteProductCat=<?php echo $productCatId ?>"><i class="fas fa-times-circle fa-2x"></i></a></td>
                                <td><a href="index.php?editProductCat=<?php echo $productCatId ?>"><i class="fas fa-edit fa-2x"></i></a></td>
                            </tr>
                                <?php  } ?>
                            </tbody>
                        </table>
