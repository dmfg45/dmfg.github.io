                ...
                <div class="panel-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="adminName" class="form-control" value="<?php echo $admin_name ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-md-3 control-label">User Password:</label>
                            <div class="col-md-6">
                                <input type="password" name="adminPw" class="form-control" value="<?php echo $admin_password ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-md-3 control-label">User Email:</label>
                            <div class="col-md-6">
                                <input type="text" name="adminEmail" class="form-control" value="<?php echo $admin_email ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-md-3 control-label">User Image:</label>
                            <div class="col-md-6">
                                <img src="adminImages/<?php echo $admin_image ?>" alt="ProfileImage" class="img-responsive" width="150" height="150">
                                <br>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="adminContact" class="form-control" value="<?php echo $admin_contact ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-md-3 control-label">User Country:</label>
                            <div class="col-md-6">
                                <input type="text" name="adminCountry" class="form-control" value="<?php echo $admin_country ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-md-3 control-label">User Job:</label>
                            <div class="col-md-6">
                                <input type="text" name="adminJob" class="form-control" value="<?php echo $admin_job ?>" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-md-3 control-label">User About:</label>
                            <div class="col-md-6">
                                <textarea name="adminAbout" id="" cols="30" rows="10" class="form-control" required><?php echo $admin_about ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
