                        ...
                        <table class="table table-bordered table-hover table-stripped">
                            ...
                            while ($row = mysqli_fetch_array($runQuery)){
                                ...
                                <tr>
                                    ...
                                    <td><img width="75" height="75" src="productImages/<?php echo$customerImage ?>" alt="ProdImg"></td>
                                    <td>
                                    ...
                                    <td><a href="index.php?deleteCustomer=<?php echo $customerId ?>"><i class="fas fa-times-circle fa-2x"></i></a></td>
                                </tr>
                                <?php
